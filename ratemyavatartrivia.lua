local trivia = {
    ...
    ["What classic video game requires you to eat all the dots throughout a maze?"] = "Pac-Man",
    ["How many cards are there in a deck of UNO?"] = "108",
    ["What are the three states of matter?"] = "Solid, liquid, and gas",
    ["How many pawns are there in chess in total?"] = "16",
    ["Who is the main character in The Legend Of Zelda?"] = "Link",
}
